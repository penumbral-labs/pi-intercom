...
### Changed
- Late replies now follow the ask's abandonment reason: replies after cancellation or successful supersession are dropped, while replies after a plain timeout remain visible with a stale-reply warning. A rejected superseding ask leaves the earlier ask live.
