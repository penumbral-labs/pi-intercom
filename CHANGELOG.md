...
- Lexically equivalent Windows agent-directory spellings now canonicalize to the same broker named-pipe path while distinct paths, including case-distinct roots, remain isolated.
